"""Player statistics dashboard for analytics CSV data."""
...
def load_player_data():
    """Load player data from the standard analytics CSV files."""
    try:
        ...
        if not df_bowl.empty and 'bowling_strike_rate' in df_bowl.columns:
